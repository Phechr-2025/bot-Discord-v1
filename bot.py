...
class ConfirmBuyView(View):
    ...
    async def _handle(self, interaction: Interaction, dest: Literal["dm", "channel"]):
        ...
        # ตัดเงินก่อน แล้วคืนเงินถ้าส่งไฟล์ไม่สำเร็จ
    ...
    @discord.ui.button(label="ส่งไฟล์ในห้องนี้", style=discord.ButtonStyle.success, custom_id='shop:file_chan')
